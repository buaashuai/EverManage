  ...
  $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
    ...
    parseDate: function (a, b, c, d) {
      ...
      var
        ...
        x = o.getSeconds(), y = o.getMilliseconds(), z = o.getDay(), A = o.getFullYear(), B = (z + 6) % 7 + 1, C = (new
        Date(A, v - 1, u) - new
        Date(A, 0, 1)) / 864e5, D = {
          d: m(u),
          D: d.dayNames[z],
      ...
      var
        $t = this, QueryObject = function (d, q) {
          "string" == typeof
            d && (d = $.data(d));
          var
            self = this, _data = d, _usecase = !0, _trim = !1, _query = q, _stripNum = /[\$,%]/g, _lastCommand = null,
            _lastField = null, _orDepth = 0, _negate = !1, _queuedOperator = "", _sorting = [], _useProperties = !0;
          if ("object" != typeof
    ...
    return this.each(function () {
      if (!this.grid) {
            ...
            headers: [], cols: [], footers: [], dragStart: function (a, b, e) {
              ...
              if (a) {
                ...
                if (f) {
                  e.prevRowHeight = f;
                  var
                    i, j, k, l = c.rowNum, m = e.scrollTop = e.bDiv.scrollTop, n = Math.round(g.position().top) - m,
                    o = n + g.height(), p = f * l;
                  if (a > o && 0 >= n && (void
              ...
              var
                b = a.p, c = b.selrow, d = b.selarrrow ? $.makeArray(b.selarrrow) : null, e = a.grid.bDiv.scrollLeft,
                f = function () {
                  var
                    g;
        ...
        var
          ...
          n = k(l, "highlight", !0), o = k(l, "hover", !0), p = k(l, "cornerall", !0), q = k(l, "icon_base", !0),
          r = $.jgrid.styleUI[d.p.styleUI || "jQueryUI"].colmenu, s = $.jgrid.msie(), t = [], u = [], v = [];
        ...
        var
          x, y = ["shiftKey", "altKey", "ctrlKey"], z = function (a, b) {
            ...
            var
              a, b, c, e, f, g, h, i, j, k, l, m = d.p, n = m.data, o = n.length, p = m.localReader, q = m.colModel,
              r = p.cell, s = (m.multiselect === !0 ? 1 : 0) + (m.subGrid === !0 ? 1 : 0) + (m.rownumbers === !0 ? 1 : 0),
            ...
            if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
              ...
              var
                ...
                B = d.p.rownumbers === !0 ? 1 : 0, C = [], J = {}, K = [], M = d.p.altRows === !0 ? d.p.altclass : "",
              ...
              var
                P, Q = O.length, R = 0, S = [], T = parseInt(d.p.rowNum, 10), U = d.p.scroll ? $.jgrid.randId() : 1,
                V = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first");
              if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                e && (T *= e + 1);
                var
                  W, X = $.isFunction(d.p.afterInsertRow), Y = !1, Z = B ? k(l, "rownumBox", !1, "jqgrid-rownum") : "",
            ...
            if (a) {
              ...
              var
                ...
                K = d.p.subGrid === !0 ? 1 : 0, M = d.p.rownumbers === !0 ? 1 : 0, N = H(J + K + M), O = G(h), P = {},
                Q = [], R = d.p.altRows === !0 ? d.p.altclass : "",
              ...
              var
                ...
                ba = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first"), ca = M ? k(l, "rownumBox", !1, "jqgrid-rownum") : "",
            ...
            var
              ...
              r = "", s = "<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>", t = "",
              u = function (a, b) {
                var
                  c;
            ...
            if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
              if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) V(b, f, e); else {
                ...
                var
                  ...
                  i = d.p.frozenColumns ? f : d.grid.headers[b].el, j = "single" === d.p.viewsortcols[1] ? !0 : !1;
            ...
            var
              a, b, c, f, g = 0, h = $.jgrid.cell_width ? 0 : z(d.p.cellLayout, 0), i = 0, j = z(d.p.scrollOffset, 0),
              k = !1, l = 0;
        ...
        var
          ia, ja, ka, la, ma, na, oa, pa, qa, ra = "<thead><tr class='ui-jqgrid-labels' role='row'>", sa = "", ta = "",
          ua = "";
        ...
        if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width - Ga).insertBefore(e.hDiv), U(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(Fa).width(e.width - Ga).insertAfter(e.hDiv), $(Fa).append(za), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), Ea && $(e.sDiv).hide()), Fa = null, d.p.caption) {
          ...
          d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function (a) {
            var
              ...
              f = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv", g = this;
    ...
    getGridParam: function (a, b) {
      ...
      return this.each(function () {
        ...
        d(a) {
          var
            b = $(l.grid.bDiv)[0].clientHeight, c = $(l.grid.bDiv)[0].scrollTop, d = $(l.rows[a]).position().top,
      ...
      return this.each(function () {
        var
          b, c, d = this, e = $.jgrid.getMethod("getStyleUI"), f = e(d.p.styleUI + ".common", "highlight", !0),
      ...
      return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function () {
        ...
        var
          y, z = 0,
          A = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "rowBox", !0, "jqgrow ui-row-" + w.p.direction), B = {},
...
!function (a) {
  ...
  a.extend(a.jgrid, {
    showModal: function (a) {
      ...
      var
        i = this, j = "rtl" === a(d.gbox).attr("dir") ? !0 : !1, k = a.jgrid.styleUI[d.styleUI || "jQueryUI"].modal,
        ...
        case"select":
          ...
          if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
            ...
            i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
              ...
              success: function (b) {
                var
                  c, d = [], e = this.elem, f = this.vl, h = a.extend({}, this.options), j = h.multiple === !0,
                  k = h.cacheUrlData === !0, l = "", m = a.isFunction(h.buildSelect) ? h.buildSelect.call(i, b) : b;
                if ("string" == typeof
    ...
    editGridRow: function (c, d) {
      ...
      return d = a.extend(!0, {
        ...
        f(c, d, e, f) {
          ...
          if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
              if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                ...
                var
                  v = a.extend({}, this.editoptions || {}, {id: h, name: h, rowId: c, oper: "edit"}), w = a.extend({}, {
                    elmprefix: "",
                    elmsuffix: "",
                    rowabove: !1,
                    rowcontent: ""
                ...
                case"checkbox":
                  if (g = String(g), m[h].editoptions && m[h].editoptions.value) {
                    ...
                    k[0] === g ? a("#" + f, e)[s.p.useProp ? "prop" : "attr"]({
                      checked: !0,
                      defaultChecked: !0
                    }) : a("#" + f, e)[s.p.useProp ? "prop" : "attr"]({checked: !1, defaultChecked: !1})
                  } else
        ...
        if (s.grid && c) {
          s.p.savedData = {};
          var
            t, u, v, w, x = s.p.id, y = "FrmGrid_" + x, z = "TblGrid_" + x, A = "#" + a.jgrid.jqID(z),
            B = {themodal: "editmod" + x, modalhead: "edithd" + x, modalcontent: "editcnt" + x, scrollelm: y}, C = !0,
            D = 1, E = 0, F = "string" == typeof
      ...
      return d = a.extend(!0, {
          ...
          if (a(c.p.colModel).each(function () {
              ...
              if (g = this.name, o = !1, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", p = "boolean" != typeof
                ...
                var
                  ...
                  h = parseInt(d.rowpos, 10) || q + 1, m = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                if (d.rowabove) {
                  var
        ...
        if (l.grid && c) {
          var
            m = l.p.id, n = "ViewGrid_" + a.jgrid.jqID(m), o = "ViewTbl_" + a.jgrid.jqID(m), p = "ViewGrid_" + m,
            q = "ViewTbl_" + m,
      ...
      return d = a.extend(!0, {
        ...
        if (e.grid && c) {
          var
            f, i, j, k, l = a.isFunction(b[e.p.id].beforeShowForm), m = a.isFunction(b[e.p.id].afterShowForm),
            n = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, o = e.p.id, p = {}, q = !0,
            r = "DelTbl_" + a.jgrid.jqID(o), s = "DelTbl_" + o,
      ...
      return this.each(function () {
        var
          ...
          o = "form_menu_" + a.jgrid.randId(), p = d.navButtonText ? d.navButtonText : k.selectcaption || "Actions",
        ...
        if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
          ...
          this.onchange = function () {
            ...
            if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + j.button + "'/>"), p.bind("click", function () {
              ...
              r.bind("click", function () {
                for (void
                  ...
                  var
                    c = void
                      0 === f.p.columns[d].search ? !0 : f.p.columns[d].search, e = f.p.columns[d].hidden === !0,
            ...
            for (d = 0; d < n.p.columns.length; d++) {
              var
                w = void
                  0 === n.p.columns[d].search ? !0 : n.p.columns[d].search, x = n.p.columns[d].hidden === !0,
      ...
      return b = a.extend({
        ...
        if (!d.p.filterToolbar) {
          ...
          var
            ...
            i = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base,
            k = function () {
              var
          ...
          b.restoreFromFilters && (g = d.p.postData.filters, g && ("string" == typeof
            ...
            var
              c, e = a(this).parents("tr:first"), f = parseInt(a("td.ui-search-oper", e).attr("colindex"), 10),
              g = a.extend({}, d.p.colModel[f].searchoptions || {}), h = g.defaultValue ? g.defaultValue : "";
        ...
        if (i.grid && i.p.cellEdit === !0) {
          ...
          if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
            if (g = a("td:eq(" + c + ")", i.rows[b]), h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c)) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j), g.addClass("edit-cell " + j), a(i.rows[b]).addClass("selected-row " + k), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c); else {
              ...
              var
                o = a.extend({}, h.editoptions || {}, {id: b + "_" + e, name: e, rowId: i.rows[b].id, oper: "edit"}),
        ...
        b(b, c, e) {
          ...
          if ("h" === e) {
            var
              ...
              l = d.rows[b].cells[c].offsetLeft + d.rows[b].cells[c].clientWidth, m = d.rows[b].cells[c].offsetLeft;
    ...
    groupingSetup: function () {
      ...
      return this.each(function () {
        ...
        var
          ...
          m = l.length ? l[0].nextSibling : null, n = a("#" + a.jgrid.jqID(b) + " span.tree-wrap-" + c.p.direction),
          o = function (b) {
            var
          ...
          s = r ? a("#" + a.jgrid.jqID(b), "#" + a.jgrid.jqID(r)) : !1, t = s && s.length ? s[0].nextSibling : null;
        if (n.hasClass(j)) {
      ...
      return this.each(function () {
        ...
        var
          h, i, j, k = this, l = k.p.groupingView, m = "", n = "", o = l.groupCollapse ? l.plusicon : l.minusicon,
          p = [], q = l.groupField.length, r = a.jgrid.styleUI[k.p.styleUI || "jQueryUI"].common;
      ...
      return b = a.extend({useColSpanStyle: !1, groupHeaders: []}, b || {}), this.each(function () {
        var
          c, d, e, f, g, h, i, j, k, l, m, n, o, p, q = this, r = 0, s = q.p.colModel, t = s.length, u = q.grid.headers,
    ...
    setTreeNode: function (b, c) {
      return this.each(function () {
        ...
        if (d.grid && d.p.treeGrid) {
          var
            e, f, g, h, i, j, k, l, m = d.p.expColInd, n = d.p.treeReader.expanded_field, o = d.p.treeReader.leaf_field,
            p = d.p.treeReader.level_field, q = d.p.treeReader.icon_field, r = d.p.treeReader.loaded,
            s = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, t = b;
      ...
      this.each(function () {
        ...
        if (c.grid && c.p.treeGrid) {
          var
            d = a(c).jqGrid("getNodeChildren", b), e = c.p.treeReader.expanded_field, f = b[c.p.localReader.id],
      ...
      return this.each(function () {
        ...
        if (d.grid && d.p.treeGrid) switch (d.p.treeGridModel) {
          case"nested":
            var
              e = d.p.treeReader.left_field, f = d.p.treeReader.right_field, g = d.p.treeReader.level_field,
      ...
      return this.each(function () {
        ...
        if (e.grid && e.p.treeGrid) {
          ...
          switch (e.p.treeGridModel) {
            case"nested":
              var
                i = e.p.treeReader.left_field, j = e.p.treeReader.right_field, k = e.p.treeReader.level_field,
                l = parseInt(b[i], 10), m = parseInt(b[j], 10), n = parseInt(b[k], 10);
      ...
      return this.each(function () {
        ...
        if (f.grid && f.p.treeGrid) switch ((null == c || "boolean" != typeof
          ...
          case"nested":
            var
              h = f.p.treeReader.left_field, i = f.p.treeReader.right_field, j = f.p.treeReader.level_field,
      ...
      return this.each(function () {
        if (this.grid && this.p.treeGrid) {
          ...
          var
            f = this.p.treeReader.expanded_field, g = this.p.treeReader.parent_id_field, h = this.p.treeReader.loaded,
      ...
      return this.each(function () {
        if (this.grid && this.p.treeGrid) {
          var
            c = this.p.treeReader.expanded_field, d = this.p.treeReader.parent_id_field, e = this.p.treeReader.loaded,
            f = this.p.treeReader.level_field, g = this.p.treeReader.left_field, h = this.p.treeReader.right_field;
          if (!b[c]) {
            var
  ...
  a.assocArraySize = function (a) {
    ...
    pivotSetup: function (c, d) {
        ...
        for (var
          ...
          for (H
            ...
            if (0 === I) D.children && void
              0 !== D.children || (D = {text: H, level: 0, children: [], label: H}), J = D.children; else {
      ...
      return this.each(function () {
        ...
        f(b) {
          var
            e, f, h, i, j = jQuery(g).jqGrid("pivotSetup", b, c), k = a.assocArraySize(j.summary) > 0 ? !0 : !1,
  ...
  a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
    saveState: function (b, c) {
        ...
        if (c) {
          ...
          if (e = jqGridUtils.parse(c), e && "object" === a.type(e)) {
            ...
            if (e.treeGrid) for (var
              ...
              var
                c = b.target || b.srcElement,
                d = a.jgrid.stripPref(e.idPrefix, a(c, n[0].rows).closest("tr.jqgrow")[0].id), f = n[0].p._index[d];
      ...
      switch (c.imptype) {
        case"xml":
          a.ajax(a.extend({
            url: c.impurl, type: c.mtype, data: c.impData, dataType: "xml", complete: function (b, f) {
        ...
        case"json":
          a.ajax(a.extend({
            url: c.impurl, type: c.mtype, data: c.impData, dataType: "json", complete: function (b) {
              try {
